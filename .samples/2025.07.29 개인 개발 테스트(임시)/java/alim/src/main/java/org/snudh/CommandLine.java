...
import org.snudh.event.AlimTalkEvent;
...
, "callback_number":"1522-2700"
        ...
        String result = restClient.post()
          .uri("https://api.mtsco.co.kr/sndng/atk/sendMessage")
  ...
  public CommandLineRunner getRunnerBean2() {
    return args -> {
      ...
      // if (service.existsAlimTalkPopedData()) {
      //   System.out.println("============================");
      ...
      // restClient.get()
      //   .uri(String.format("http://localhost:8021/api/v1/rsvdate/register?dday=%d", dday))
      //   .retrieve()
      //   .body(String.class);
      ...
      //   // //List<RsvInfoDto> footballTeamMap = objectMapper.readValue(p1, new TypeReference<>(){});
...
""";
  ...
  //@Bean
  public ApplicationRunner getRunnerBean4() {
    return args -> {
      System.out.println("Runner Bean ##");  // 2
