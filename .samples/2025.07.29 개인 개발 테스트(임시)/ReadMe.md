...
$> docker compose -f .devcontainer/docker-compose.yaml up discovery gateway ocs -d
$> docker compose -f .devcontainer/docker-compose.yaml up ocs -d
$> docker compose -f .devcontainer/docker-compose.yaml up alim
...
```http
GET http://172.31.37.51:8080/ocs/api/v1/rsvdate/medis?dday=2
```

```http
GET http://172.31.37.51:8080/ocs/api/v1/rsvdate/exams?dday=2
```
...
```http
http://172.31.37.51:8080/service/ocs/RsvDrSch/00497017/2024-10-08T09:30:00/29
```
...
```http
GET http://localhost:8021/api/v1/alimtalk/token/eyJwdG4iOiIwMTAyODgwNCIsIm1kdCI6MTcyOTYzOTgwMCwibWRkIjoiMDMifQ.G0fdIymVDGfGi9Hnot8Hqw-MQp4A8iMFI9rjVGDceYA
```
